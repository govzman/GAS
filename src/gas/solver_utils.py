"""
Adapted from the official DPM-Solver implementation:
...
class NoiseScheduleVP:
    ...
    def numerical_clip_alpha(self, log_alphas, clipped_lambda=-5.1):
        ...
        if idx > 0:
            raise TypeError("CHEEECK NOISE SCHEDULER")
...
def model_wrapper(
    ...
    class model_fn:
        def __call__(self, x, t_continuous):
            """
    ...
    function = model_fn()
    function.unconditional_condition = unconditional_condition

import torch
from src.model.gas.base_model import BaseModel, EDMModel, LDMModel, SDModel
from src.model.gas.gs_wrapper import GSWrapper, GSWrapperLatent
from omegaconf import DictConfig


def load_base_model(config: DictConfig, device=torch.device('cuda')) -> BaseModel:
    if config.type == 'EDM':
...
def get_gs_wrapper(model: BaseModel, solver_config: DictConfig) -> GSWrapper:
